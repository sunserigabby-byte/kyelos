  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-3 mb-3">
      <button onClick={() => setOpen((v) => !v)} className="tappable w-full text-left flex items-center justify-between">
        <div>
          <div className="font-bold text-navy text-sm">Single-Leg Maintenance (LEFT) — Optional</div>
      ...
      {open && (
        <div className="mt-2">
          <div className="bg-gold-light/40 border-l-4 border-gold px-3 py-2 mb-2 text-xs text-navy">
